...
By Homework 3 (affine maps induce isomorphism on cohomology), we may compute the $i_*\OO_{\PP^{n-1}}(d)$ terms on $\PP^{n-1}$. Then the $H^i(\oplus \OO_{\PP^{n-1}}(d)) = 0$ for $1 \le i \le n- 2$. This yields chunks of the sequence like
...
\end{align*}
with our knowledge of the degree cohomology of projective space, the connecting morphism must be $\delta = \times x_n^{-1}$. In particular, this map is injective. Thus we get
\begin{align*}
&0 \to H^{n-1} \left( \bigoplus_{d \in \Z} \OO_{\PP^n}(d-1) \right)  \stackrel{\times x_n }{\to} H^{n-1} \left(\bigoplus_{d \in \Z}\OO_{\PP^n}(d) \right) \to H^{n-1} \to 0
\end{align*}
