...
Note that we are using that $\varphi$ maps homeomorphically onto its image to get that $\varphi_*(\OO_{X,P}) = \OO_{X,P}$. Now, both rings have the same residue field, and (2) implies that the image of $m_{\PP^n,P}$ generates $m_{X,P}/m_{X,P}^2$. Then this turns into:
\begin{itemize}
